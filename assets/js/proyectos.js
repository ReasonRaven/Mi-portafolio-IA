...
window.PORTAFOLIO = {
  ...
  /* Actividades extracurriculares. Se pintan en el inicio, en su propia
     seccion, aparte de los proyectos. Lo mas reciente va primero.
       ...
       constanciaUrl opcional, la constancia (desde la raiz). Va como imagen
                     a proposito: un PDF conserva el texto debajo de
                     cualquier tachado, una imagen no.                */
  extracurriculares: [
    {
      id: "kickboxing",
    ...
    },
    {
      ...
      constanciaUrl: "Extracurriculares/ConstanciaEsports2025.png"
    },
    {
      id: "modeva",
